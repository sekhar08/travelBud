  ...
  const upcomingTrips = sortedTrips.filter(
    ...
    return (
        <div className="space-y-6 container mx-auto px-4 py-8">
            ...
            <CardContent>
                <p>{trips.length == 0 ? "Start planning your first trip by clicking the button above" : `You have ${trips.length} trip${trips.length==1 ? "" : "s"} planned. ${ upcomingTrips.length > 0 ? `${upcomingTrips.length} upcoming.` : ""}`}</p>
            </CardContent>
