    ...
    <nav className="bg-white shadow-md py-4 border-b border-gray-200">
      <div className="container mx-auto flex justify-between items-center">
        <div className="text-lg font-bold">
            ...
            <Image src="/logo.png" alt="TravelBud" width={50} height={50} />
            <span className="text-2xl font-bold text-gray-800">TravelBud</span>
            </Link> 
            </div>
       ...
       {session ? (
          <div className="flex items-center gap-6">
            ...
            <Link
                href="/trips"
                className="px-2 py-1 flex items-center hover:text-blue-500 transition-colors duration-200"
            >
                My Trips
            </Link>
            <Link
            ...
            <button
            className="flex items-center bg-gray-800 hover:bg-gray-900 text-white px-4 py-2 rounded-sm cursor-pointer" onClick={logout}
          >
            Sign Out
          </button>
          ...
          <button
            className="flex items-center bg-gray-800 hover:bg-gray-900 text-white px-4 py-2 rounded-sm cursor-pointer" onClick={login}
          >
            Sign In
            <svg
